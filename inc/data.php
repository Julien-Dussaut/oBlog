...
$dataCategoriesList = [
    // ID => objet Category
    1 => new Category('TeamBack', 1),
    2 => new Category('TeamFront', 2),
    3 => new Category('Collaboration', 3),
    4 => new Category('Ma Vie De Dev', 4)
];

// Les auteurs
$dataAuthorsList = [
    // ID => objet Author
    1 => new Author('Maxime', 1),
    2 => new Author('Anthony', 2),
    3 => new Author('Alexandre', 3),
    4 => new Author('Dario', 4),
    5 => new Author('Julie', 5),
    6 => new Author('Lucie', 6),
    7 => new Author('Xavier', 7)
];
